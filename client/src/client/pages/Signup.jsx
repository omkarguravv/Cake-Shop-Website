                    ...
                    <form className="mt-8 space-y-6" action="#" method="POST" onSubmit={registerUser}>
                        ...
                        <div className="-space-y-px rounded-md shadow-sm ">
                            ...
                            <div className='py-4'>
                                ...
                                <input id="email-address" name="email" type="password" autoComplete="email" required className="  relative block w-full appearance-none  rounded-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="Password" onChange={(e)=>{
                        ...
                        <div>
                        <Link to='/signin'><button type="submit" className="group relative flex w-full justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
