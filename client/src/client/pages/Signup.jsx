                    ...
                    <form className="mt-8 space-y-6" action="#" method="POST" onSubmit={registerUser}>
                        ...
                        <div className="-space-y-px rounded-md shadow-sm ">
                            ...
                            <div >
                                ...
                                className="
                                relative block w-full appearance-none  rounded-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-yellow-500 focus:outline-none focus:ring-yellow-500 sm:text-sm
                            ...
                            <div className='py-4'>
                                ...
                                <input id="lastName" name="lastName" type="text" autoComplete="current-password" required className=" relative block w-full appearance-none  rounded-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-yellow-500 focus:outline-none focus:ring-yellow-500 sm:text-sm" placeholder="Last Name" onChange={(e) => {
                        ...
                        <div>
                            {/* <Link to=''>  */}
                                ...
                                <span className="absolute inset-y-0 left-0 flex items-center pl-3">
                                    <svg className="h-5 w-5 text-[#F3C623]group-hover:text-indigo-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
